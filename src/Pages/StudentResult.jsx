...
const StudentResult = () => {
    // Mock Data
    const results = [
        { id: 1, title: "Calculus Midterm", date: "Oct 24, 2024", score: "22/25", percentage: "88%", grade: "A" },
        { id: 2, title: "Physics Quiz 1", date: "Sep 15, 2024", score: "8/10", percentage: "80%", grade: "B+" },
    ];

    return (
        <>
            <h1 className="text-3xl font-bold text-[#0F6B75] mb-8">My Results</h1>

            {/* Performance Summary */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-gradient-to-br from-[#0F6B75] to-[#0c565e] p-6 rounded-2xl shadow-lg text-white">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <h3 className="text-lg font-bold text-gray-800 p-6 border-b border-gray-200">Recent Exams</h3>
                <div className="divide-y divide-gray-100">
                    {results.map((res) => (
                        <div key={res.id} className="p-6 flex flex-col md:flex-row justify-between items-center gap-4 hover:bg-gray-50 transition-colors">
