...
import { Calendar, Clock, BookOpen, ChevronRight, PenTool } from 'lucide-react';
  ...
  const exams = [
    {
      ...
      totalMarks: 50,
      questionsList: [
        { id: 101, text: "What is the derivative of x^2?", type: "mcq", marks: 5, options: ["x", "2x", "x^2", "2"], correctOption: 1 },
        { id: 102, text: "Calculate the integral of 2x dx.", type: "mcq", marks: 5, options: ["x^2 + C", "2x^2 + C", "x + C", "2x"], correctOption: 0 },
        { id: 103, text: "What is the value of pi?", type: "mcq", marks: 5, options: ["3.14", "3.14159", "22/7", "All of above"], correctOption: 3 },
      ]
    },
    {
      id: 2,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4">
        {exams.map((exam) => (
          <div key={exam.id} className="bg-white p-5 rounded-xl border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span>{exam.questionsList?.length || exam.questions} Qs ({exam.totalMarks} Marks)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                {exam.status === 'Completed' ? (
                  <div className="text-right">
                    ...
                    <p className="text-xl font-bold text-[#0F6B75]">{exam.score} / {exam.totalMarks}</p>
                  </div>
                ) : (
                  <button
                  ...
                  >
                    {exam.status === 'Available' ? <PenTool size={18} /> : <Clock size={18} />}
